...
import { companies, getCompaniesByTier, Company } from '@/lib/companyData';
...
function TierSection({ tier, title, icon: Icon, companies }: { 
  tier: 1 | 2 | 3; 
  title: string; 
  icon: typeof Trophy;
  companies: Company[];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-8 p-4 rounded-lg bg-muted/50 border border-border text-center">
          <p className="text-sm text-muted-foreground">
            💡 Problems are mapped based on real interview patterns. Frequency data is updated regularly.
          </p>
        </div>
      </div>
    </div>

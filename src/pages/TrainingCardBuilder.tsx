...
const TrainingCardBuilder = () => {
  ...
  const canProceed = () => {
    switch (step) {
      case 1:
        return formData.goal && formData.focus;
      case 2:
        return formData.solvedCount > 0 && formData.language;
      case 3:
        return formData.dailyCommitment && formData.preferredSlots.length > 0 && formData.pace;
      case 4:
        return formData.commStyle && formData.accountabilityStyle;
      default:
        return false;
    }
  };
            ...
            <Card className="bg-card/50 backdrop-blur border-border/50">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <RadioGroup
                    value={formData.goal}
                    onValueChange={(v) => updateField('goal', v as PartnerGoal)}
                ...
                <div className="space-y-3">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(v) => updateField('focus', v as PartnerFocus)}
                    className="space-y-2"
                  >
                    {[
          ...
          {step === 2 && (
            <Card className="bg-card/50 backdrop-blur border-border/50">
              <CardHeader>
                ...
                <CardDescription>
                  Matching is based on discipline, not popularity.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {/* Solved Count */}
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateField('solvedCount', parseInt(e.target.value) || 0)}
                    placeholder="e.g., 350"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateField('internalRating', parseInt(e.target.value) || 1200)}
                    placeholder="e.g., 1650"
                    className="bg-background/50"
                  />
                  <p className="text-xs text-muted-foreground">
                    Based on your solve patterns (800-3000 range)
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateField('contestRating', e.target.value)}
                    placeholder="e.g., LeetCode 1756 / Codeforces 1400"
                    className="bg-background/50"
                  />
                </div>
          ...
          {step === 3 && (
            <Card className="bg-card/50 backdrop-blur border-border/50">
              <CardHeader>
                ...
                <CardDescription>
                  When and how do you want to train?
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {/* Daily Commitment */}
                <div className="space-y-3">
                  ...
                  <RadioGroup
                    value={String(formData.dailyCommitment)}
                    onValueChange={(v) => updateField('dailyCommitment', parseInt(v) as 30 | 60 | 90)}
                    className="flex gap-4"
                  >
                    {[
                      ...
                      <label
                        key={option.value}
                        className={`flex-1 flex items-center justify-center p-4 rounded-lg border-2 cursor-pointer transition-all ${
                          String(formData.dailyCommitment) === option.value 
                            ? 'border-primary bg-primary/5' 
                            : 'border-border hover:border-primary/50'
                        }`}
                      >
                ...
                <div className="space-y-3">
                  ...
                  <RadioGroup
                    value={formData.pace}
                    onValueChange={(v) => updateField('pace', v as PartnerPace)}
                    className="space-y-2"
                  >
                    {[
            ...
            <Card className="bg-card/50 backdrop-blur border-border/50">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <RadioGroup
                    value={formData.commStyle}
                    onValueChange={(v) => updateField('commStyle', v as CommStyle)}
                    className="space-y-2"
                  >
                    {[
                      ...
                      <label
                        key={option.value}
                        className={`flex items-center justify-between p-4 rounded-lg border-2 cursor-pointer transition-all ${
                          formData.commStyle === option.value 
                            ? 'border-primary bg-primary/5' 
                            : 'border-border hover:border-primary/50'
                        }`}
                      >
                ...
                <div className="space-y-3">
                  ...
                  <RadioGroup
                    value={formData.accountabilityStyle}
                    onValueChange={(v) => updateField('accountabilityStyle', v as AccountabilityStyle)}
                    className="space-y-2"
                  >
                    {[
                      ...
                      <label
                        key={option.value}
                        className={`flex items-center justify-between p-4 rounded-lg border-2 cursor-pointer transition-all ${
                          formData.accountabilityStyle === option.value 
                            ? 'border-primary bg-primary/5' 
                            : 'border-border hover:border-primary/50'
                        }`}
                      >
                ...
                <div className="p-4 rounded-lg border-2 border-border bg-card/30">
                  <label className="flex items-start gap-3 cursor-pointer">
                    <Checkbox
                      checked={formData.noGhostingRule}
                      onCheckedChange={(checked) => updateField('noGhostingRule', !!checked)}
                      className="mt-0.5"
                    />
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        Auto-rematch after 3 consecutive misses. Protects both partners.
                      </p>
                    </div>
                  </label>
                </div>
